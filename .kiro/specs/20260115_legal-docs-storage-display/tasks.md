...
- [ ] 3. Webアプリ: LegalDocumentServiceの実装 (P)
...
- [ ] 4. Webアプリ: LegalDocumentViewerコンポーネントの実装 (P)
...
- [ ] 8. Flutterアプリ: LegalDocumentScreenの実装 (P)
...
- [ ] 9. Flutterアプリ: settings_screenの更新
...
- [ ] 10. 法的文書のStorageへのアップロード（初回セットアップ）
